 ...
 * 사용:
 *   npm run build
 *   node .claude/skills/visual-verify/scripts/shot-el.mjs guide '.fc-svg' shot.png
 *   node .claude/skills/visual-verify/scripts/shot-el.mjs map '.rm-legend' shot.png --w=390
 *   node .claude/skills/visual-verify/scripts/shot-el.mjs "" '.hero' shot.png --nth=0
 *
...
if (!sel) {
  console.error("사용: node .claude/skills/visual-verify/scripts/shot-el.mjs <경로> '<선택자>' [출력.png] [--w=] [--nth=]");
  process.exit(1);
}
