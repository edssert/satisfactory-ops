 ...
 *
 * 사용:
 *   node .agents/skills/satisfactory-data-evidence/scripts/field-scope.mjs mSpeed
 *   node .agents/skills/satisfactory-data-evidence/scripts/field-scope.mjs mSpeed --gen
 *
...
if (!field) {
  console.error('사용: node .agents/skills/satisfactory-data-evidence/scripts/field-scope.mjs <필드명> [--gen]');
  process.exit(1);
}
